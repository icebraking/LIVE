/* =======================================================================
   ...
   Per-driver fields:
     ...
     w/p   career wins / poles (post-R7)
     pod   career NON-WINNING podiums, i.e. P2-P3 finishes only (post-R7) — a win
           is counted under w, never also under pod
...
(function (root, factory) {
  ...
  var DRIVERS = [
    // Mercedes
    { id: 'antonelli',     name: 'Kimi Antonelli',   team: 'Mercedes',     rf: 0.735, starts: 31,  w: 5,   p: 4,   pod: 4,   h2h: 28.00, dnf: 1, pts: 156, rp: [18, 29, 25, 28, 31, 25, 0] },
    { id: 'russell',       name: 'George Russell',   team: 'Mercedes',     rf: 0.936, starts: 159, w: 6,   p: 10,  pod: 21,  h2h: 67.21, dnf: 1, pts: 106, rp: [25, 26, 12, 17, 8, 0, 18] },
    // Ferrari
    { id: 'hamilton',      name: 'Lewis Hamilton',   team: 'Ferrari',      rf: 0.863, starts: 387, w: 106, p: 104, pod: 100, h2h: 58.44, dnf: 0, pts: 115, rp: [12, 21, 8, 10, 21, 18, 25] },
    { id: 'leclerc',       name: 'Charles Leclerc',  team: 'Ferrari',      rf: 0.940, starts: 178, w: 8,   p: 27,  pod: 44,  h2h: 65.44, dnf: 2, pts: 75,  rp: [15, 19, 15, 10, 16, 0, 0] },
    // McLaren
    { id: 'norris',        name: 'Lando Norris',     team: 'McLaren',      rf: 0.936, starts: 158, w: 11,  p: 16,  pod: 35,  h2h: 64.57, dnf: 3, pts: 73,  rp: [10, 5, 10, 26, 7, 0, 15] },
    { id: 'piastri',       name: 'Oscar Piastri',    team: 'McLaren',      rf: 0.916, starts: 75,  w: 9,   p: 6,   pod: 19,  h2h: 31.25, dnf: 2, pts: 68,  rp: [0, 3, 18, 22, 5, 10, 10] },
    // Red Bull
    { id: 'max_verstappen', name: 'Max Verstappen',  team: 'Red Bull',     rf: 0.955, starts: 240, w: 71,  p: 48,  pod: 57,  h2h: 84.52, dnf: 2, pts: 55,  rp: [8, 0, 4, 14, 17, 0, 12] },
    { id: 'hadjar',        name: 'Isack Hadjar',     team: 'Red Bull',     rf: 0.833, starts: 30,  w: 0,   p: 0,   pod: 1,   h2h: 57.14, dnf: 2, pts: 34,  rp: [0, 4, 0, 0, 10, 12, 8] },
    // Alpine
    { id: 'gasly',         name: 'Pierre Gasly',     team: 'Alpine',       rf: 0.942, starts: 184, w: 1,   p: 0,   pod: 4,   h2h: 56.00, dnf: 1, pts: 41,  rp: [1, 8, 6, 1, 4, 15, 6] },
    ...
    { id: 'ocon',          name: 'Esteban Ocon',     team: 'Haas',         rf: 0.942, starts: 187, w: 1,   p: 0,   pod: 3,   h2h: 47.10, dnf: 0, pts: 3,   rp: [0, 0, 1, 0, 0, 2, 0] },
    // Williams
    { id: 'sainz',         name: 'Carlos Sainz',     team: 'Williams',     rf: 0.954, starts: 236, w: 4,   p: 6,   pod: 25,  h2h: 47.40, dnf: 1, pts: 6,   rp: [0, 2, 0, 2, 2, 0, 0] },
    ...
    // Aston Martin
    { id: 'alonso',        name: 'Fernando Alonso',  team: 'Aston Martin', rf: 0.650, starts: 432, w: 32,  p: 22,  pod: 74,  h2h: 77.74, dnf: 4, pts: 1,   rp: [0, 0, 0, 0, 0, 1, 0] },
    { id: 'stroll',        name: 'Lance Stroll',     team: 'Aston Martin', rf: 0.944, starts: 196, w: 0,   p: 1,   pod: 3,   h2h: 34.31, dnf: 5, pts: 0,   rp: [0, 0, 0, 0, 0, 0, 0] },
    // Cadillac
    { id: 'bottas',        name: 'Valtteri Bottas',  team: 'Cadillac',     rf: 0.958, starts: 253, w: 10,  p: 20,  pod: 57,  h2h: 41.92, dnf: 3, pts: 0,   rp: [0, 0, 0, 0, 0, 0, 0] },
    { id: 'perez',         name: 'Sergio Perez',     team: 'Cadillac',     rf: 0.966, starts: 288, w: 6,   p: 3,   pod: 33,  h2h: 36.49, dnf: 1, pts: 0,   rp: [0, 0, 0, 0, 0, 0, 0] }
  ];
  ...
  var LOCKED = {
    ...
    mom: { wRec: 0.7, wSea: 0.3, beta: 0.7 },
    dnf: { df: 0.30, cap: 4 },
    perDriverCap: 399
  };
